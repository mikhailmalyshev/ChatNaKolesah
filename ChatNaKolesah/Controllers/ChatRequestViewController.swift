...
//  ChatNaKolesah
//
//  Created by Михаил Малышев on 15.10.2020.
...
class ChatRequestViewController: UIViewController {
    ...
    let aboutMeLabel = UILabel(text: "U have the opportunity to star a new chat", font: .systemFont(ofSize: 16, weight: .light))
    let acceptButton = UIButton(backgroundColor: .black, titleColor: .white, title: "ACCEPT", font: .laoSangamMN20(), isShadow: false, cornerRadius: 10)
    let denyButton = UIButton(backgroundColor: .mainWhite(), titleColor: #colorLiteral(red: 0.8352941176, green: 0.2, blue: 0.2, alpha: 1), title: "DENY", font: .laoSangamMN20(), isShadow: false, cornerRadius: 10)
